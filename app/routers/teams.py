...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=models.TeamRead)
def create_team(*, session: Session = Depends(get_session), team: models.TeamCreate):
